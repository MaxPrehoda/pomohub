...
function TaskList() {
  ...
  return (
    <div className="flex flex-col w-2/6 lg:w-[440px] gap-3 text-white font-medium">
      ...
      <div className="bg-zinc-700 p-2 rounded-md text-left hover:opacity-60">
        <input className="mr-1" type="checkbox"></input> Take out trash
      </div>
      <div className="bg-zinc-700 p-2 rounded-md text-left hover:opacity-60">
        <input className="mr-2" type="checkbox"></input>Mock up text
      </div>
      <div className="bg-zinc-700 p-2 rounded-md text-left hover:opacity-60">
        <input className="mr-2" type="checkbox"></input>More of that
      </div>
      <div className="bg-zinc-700 p-2 rounded-md text-left hover:opacity-60">
        <input className="mr-2" type="checkbox"></input>And even more
      </div>
