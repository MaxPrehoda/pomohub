    ...
    return (
        <div className='flex flex-col w-2/6 lg:w-[440px] gap-3 text-white font-medium'>
            ...
            <div className='bg-transparent p-2 rounded-md text-center hover:opacity-60 border-2 border-zinc-700'>
                <input className='bg-transparent' name='task' placeholder='Task Name' value={task}
                    onChange={handleChange}></input><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="inline w-6 h-6 pr-1">
