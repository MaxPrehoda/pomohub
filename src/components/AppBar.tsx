      ...
      <div className="pb-6 draggable">
        <div className="py-0.5 flex justify-between draggable bg-transparent text-zinc-400">
          ...
          <div className="inline-flex -mt-1">
            ...
            <button onClick={window.Main.Minimize} className="undraggable md:px-4 lg:px-3 pt-1 hover:bg-gray-300 pb-1">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
            ...
            <button onClick={handleToggle} className="undraggable px-6 lg:px-5 pt-1 hover:bg-gray-300 pb-1">
              {isMaximize ? (
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
